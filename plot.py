...
try:
    os.mkdir('/media/jan/LARA-02/PGP-pancreas-JAN/Projekt/distanceData/')
except:
    pass
...
for f in os.listdir(data_path):
    f =data_path+f
    if f.endswith('.data'):
        anno_name = f.split('/')[-1].split('.')[0] + '.csv'
...
for d in data:
    ...
    try:
        ...
        fout = open("/media/jan/LARA-02/PGP-pancreas-JAN/Projekt/distanceData/"+out_name+".data","w")
